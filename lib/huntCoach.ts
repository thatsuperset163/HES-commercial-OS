...
export const HUNT_WEEK: HuntDayPlan[] = [
  {
    ...
    actions: [
      ...
      {
        id: "mon-log",
        label: "Log who answered in Work notes / Tasks",
        href: "/work/tasks",
        cta: "Go to Tasks",
      },
    ],
  ...
  },
  {
    ...
    actions: [
      ...
      {
        id: "sun-ideas",
        label: "Parking lot cleanup — keep 1 idea max in Tasks notes",
        href: "/work/tasks",
        cta: "Go to Tasks",
      },
      {
        id: "sun-rest",
        label: "Stop building. Rest and reset for Monday’s hunt",
        href: "/work",
        cta: "Open Work",
      },
    ],
